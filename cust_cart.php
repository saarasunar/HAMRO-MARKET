...
<head>
    ...
    <title>My Cart | Hamro Pasal</title>
</head>
                    ...
                    <div class="col">
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                FROM cart ct INNER JOIN category f ON ct.f_id = f.f_id WHERE ct.c_id = {$_SESSION['cid']}";
            ...
            <i class="bi bi-trash"></i>
                                ...
                                <div class="ms-3 mt-3 me-auto">
                                    <div class="fw-normal"><span class="h5"><?php echo $row["ct_amount"]?>x</span>
                                        <?php echo $row["f_name"]?>
                                        <p><?php printf("%.2f NRP <small class='text-muted'>(%.2f NRP each)</small>",$row["f_price"]*$row["ct_amount"],$row["f_price"])?><br />
                            ...
                            <ul class="list-inline justify-content-between">
                                ...
                                <li class="list-inline-item fw-bold h4">
                                    <?php
                                        ...
                                        $gt_query = "SELECT SUM(ct.ct_amount*f.f_price) AS grandtotal FROM cart ct INNER JOIN category f 
    ...
    <div class="row row-cols-1">
        ...
        <div class="col mb-3">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title text-primary fw-bold">My Information</h5>
                    <ul class="list-unstyled small">
                        ...
                        <li><strong>Email:</strong> <?php echo $cust_arr["c_email"]; ?></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card shadow-sm border-0">
                <div class="card-body text-center">
                    <?php if ($no_order) { ?>
                        <!-- Disabled Button for Ineligible Orders -->
                        <button type="button" class="btn btn-danger w-100" disabled>
                            <i class="bi bi-x-circle me-2"></i>
                            <?php
                                echo !$min_cost 
                                    ? "Your order is less than the minimum amount." 
                                    : "Cannot proceed with payment.";
                            ?>
                        </button>
                    <?php } else { ?>
                        <!-- Active Payment Button -->
                        <a href="payment.php" class="btn btn-info w-100">
                            <i class="bi bi-qr-code-scan"></i> Proceed with Payment
                        </a>
                    <?php } ?>
                </div>
            </div>
