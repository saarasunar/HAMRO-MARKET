...
<head>
    ...
    <title>Successfully Order | Hamro Pasal</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center reg-success mt-auto">
            ...
            <a class="btn btn-outline-warning btn-sm" href="index.php">Return to home</a>
            <a class="btn btn-info btn-sm" href="cust_order_history.php">Go to order history page</a>
    </div>
