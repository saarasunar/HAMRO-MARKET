...
<br><br><br><br>
    <div class="container px-5 py-4" id="shop-body">
        ...
        <h3 class="border-top pt-3 my-2">
            <a class="text-decoration-none link-secondary" href="admin_shop_detail.php?s_id=<?php echo $s_id?>">Products</a>
                ...
                <div class="row g-2">
                    ...
                    <div class="col">
                        <select class="form-select" id="utype" name="ut">
                            ...
                            <option value="CUS" <?php if($_GET["ut"]=="CUS"){ echo "selected";}?>>Regular_Customer</option>
