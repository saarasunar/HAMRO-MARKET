<?php
    ...
    $shop_id = $shop_arr["s_id"];
       ...
       $order_cost = $gt_arr["grandtotal"];
            ...
            $ord_vl = "";
            $crt_query = "SELECT ct.f_id,f.f_price,ct.ct_amount,ct.ct_note FROM cart ct INNER JOIN category f ON ct.f_id = f.f_id WHERE ct.c_id = {$_SESSION['cid']} AND ct.s_id = {$shop_id};\n";
