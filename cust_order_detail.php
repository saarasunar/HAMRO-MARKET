            ...
            <div class="col">
                <div class="row row-cols-1">
                    ...
                    <div class="col row row-cols-1 row-cols-md-2 border-bottom">
                        <?php 
                            $ord_query = "SELECT f.f_name,f.f_pic,ord.ord_amount,ord.ord_buyprice,ord_note FROM order_detail ord INNER JOIN category f ON ord.f_id = f.f_id WHERE ord.orh_id = {$orh_id}";
                                ...
                                <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                    ...
                                    <div class="ms-3 me-auto">
                                        <div class="fw-normal"><span class="h5"><?php echo $ord_row["ord_amount"]?>x </span><?php echo $ord_row["f_name"]?>
                                            <p><?php printf("%.2f NRP <small class='text-muted'>(%.2f NRP each)</small>",$ord_row["ord_buyprice"]*$ord_row["ord_amount"],$ord_row["ord_buyprice"]);?><br />
