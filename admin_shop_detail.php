...
<head>
    ...
    <title>Shop Profile | Hamro Pasal</title>
</head>
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="container row row-cols-6 row-cols-md-12 g-5 pt-4 mb-4" id="shop-header">
            ...
            <div class="col-6 col-md-8">
                ...
                <li class=""><?php echo $shop_row["s_desc"];?></li>
                <br>
                    <li class=""><?php echo $shop_row["s_location"];?></li>
                    
                    <li class="">Telephone number: <?php echo "(+977) ".$shop_row["s_phoneno"];?></li>
                </ul>
                <a class="btn btn-sm btn-warning" href="admin_shop_pwd.php?s_id=<?php echo $s_id?>">
            <i class="bi bi-key"></i>
            Change password
        </a>
        <a class="btn btn-sm btn-info mt-2 mt-md-0" href="admin_shop_edit.php?s_id=<?php echo $s_id?>">
        ...
        <!-- GRID Product SELECTION -->
        <div class="container">
        <h3 class="border-top pt-3 my-2">
            <a class="text-decoration-none link-success" href="admin_shop_detail.php?s_id=<?php echo $s_id?>">Products</a>
            ...
            <form class="form-floating mb-1 " method="GET" action="admin_shop_detail.php">
                <div class="row g-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="categoryname" name="fdn" placeholder="category name"
                    ...
                    <div class="col-auto">
                        ...
                        <a href="admin_category_add.php?s_id=<?php echo $s_id?>" class="btn btn-primary">Add new Product</a>
                    </div>
                </div>
            </form>
        </div>
        <?php
            ...
            if(isset($_GET["search"])){
                $query = "SELECT * FROM category WHERE s_id = {$s_id} AND f_name LIKE '%{$_GET['fdn']}%' ORDER BY f_price DESC;";
            }else{
                $query = "SELECT * FROM category WHERE s_id = {$s_id} ORDER BY f_price DESC;";
            }
            $result = $mysqli -> query($query);
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php printf("%.2f NRP",$row["f_price"]);?></td>
                        
                        <td>
                            <a href="admin_category_detail.php?f_id=<?php echo $row["f_id"]?>"
                                class="btn btn-sm btn-primary">View</a>
                            <a href="admin_category_edit.php?f_id=<?php echo $row["f_id"]?>"
                                class="btn btn-sm btn-outline-success">Edit</a>
                            <a href="admin_category_delete.php?f_id=<?php echo $row["f_id"]?>"
        ...
        <div class="row">
            <div class="col m-2 p-2 bg-danger text-white rounded text-start">
                <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">No Product found in this shop</span>
